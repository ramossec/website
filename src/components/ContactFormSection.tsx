    ...
    <section id="contato" className="section-padding bg-[#f5f7fa]">
      <div className="container-custom">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="section-title-center">Entre em Contato</h2>
          <p className="text-gray-600">
            Estamos prontos para ajudar sua empresa a alcançar novos patamares de segurança e eficiência digital.
          </p>
        </div>
